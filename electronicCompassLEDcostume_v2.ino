...
void loop() {
  if (button.isPressed() == true && numClicks < 9) {            // Keeps track of number of button presses
    numClicks += 1;
  } else if (button.isPressed() == true && numClicks == 9) {    // Resets number of button presses
    numClicks = 0;
  }
  ...
  switch (numClicks) {
    case 0:
      Serial.println("case 0 is all LEDs off");
      for (int i = 0; i < 10; i++) {
        calActive = getNum();
        redArray[i] = 0;
        greenArray[i] = 0;
      ...
      break;
    case 1:
      Serial.println("case 1 is calibrate");
      if (calDone == 998) {
        for (int i = 0; i < 10; i++) {
          calActive = getNum();
      ...
      break;
    case 2:
      Serial.println("case 2 is chase effect");
      if (chaseDone == 998) {
      ...
      break;
    case 3:
      Serial.println("case 3 is MyRec");
    ...
    case 5:
      Serial.println("case 5 is NewDir");       // This is like case 3
      if (newCal == 999) {
    ...
    case 7:
      Serial.println("case 7 is random");
      if (randomDone == 998) {
        for (int i = 0; i < 46; i++) {
          calActive = getNum();
      ...
      break;
    case 8:
      Serial.println("case 8 is MyRec, again");       // This uses what was gotten in case 3
      num = getNum() + myRecAdjust;
      if (num < 30 || num > 50) {
        num = 0;
      } else if (num >= 30 && num <= 40) {
    ...
    case 9:
      Serial.println("case 9 is reset, turns LEDs blue");       // Blue LEDs indicate it got ready to start over
      myCal = 998;
      newCal = 998;
      calDone = 998;
      chaseDone = 998;
